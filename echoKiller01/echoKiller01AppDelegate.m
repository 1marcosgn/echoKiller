...
#import "echoKiller01AppDelegate.h"

@implementation echoKiller01AppDelegate
...
-(void) estiloHead{
    ...
    UIImage *navimage = [[UIImage imageNamed:@"black_banner.png"]resizableImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
